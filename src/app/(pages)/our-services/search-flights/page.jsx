...
export default function FlightDetailsWeb() {
  ...
  return (
    ...
    <button onClick={() => router.push("/our-services/travel-plan")} className="w-full max-w-md cursor-pointer bg-green-600 hover:bg-green-700 text-white font-bold py-3 !rounded-lg transition">
      Continue
    </button>
  </div>
