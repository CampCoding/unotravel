            ...
            <div className="flex flex-col">
              ...
              >
                <div className="flex  !items-center gap-[10px]">
                  ...
                  <p className="italic my-auto  font-bold text-[#264787] !text-base 2xl:!text-[20px]">
                    Adult's
                  </p>
                </div>
              ...
              <button
               onClick={() => router.push("/sign-in")}
                data-aos="fade-up"
                data-aos-delay={300}
                className="bg-[#264787] !font-bold !rounded-[37px] flex justify-center items-center h-[60px] text-white text-xl 2xl:!text-[28px]"
              >
                Register Now
              </button>
            </div>
