...
const FALLBACK_MAP_URL =
  "https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1713.4790645784678!2d30.970042940261838!3d30.80380848040875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2seg!4v1753540375154!5m2!1sen!2seg";

export default function ContactUsMap({ visitUs, langId }) {
  const settings = visitUs?.siteSettings || {};
  const branches = visitUs?.branches || [];
  const callCenterNumbers = visitUs?.callCenterNumbers || [];

  const mapUrl = settings.map_embed_url || FALLBACK_MAP_URL;
  const phone = settings.contact_phone;
  const mobile = settings.contact_mobile;
  const email = settings.contact_email;
  const orgNumber = settings.org_number;

  const getCountryName = (number) => {
    const t =
      number?.translations?.find((t) => t.language_id === Number(langId)) ||
        ...
        <div className="flex flex-col gap-1">
          ...
          {branches.length > 0 ? (
            branches.map((branch) => (
              <div key={branch.branch_id}>
                <p className="text-(--main-dark-color) mb-0! pb-0! font-medium">{branch.title}</p>
           ...
           <div>
            ...
            <div className="flex flex-col gap-0! mt-3">
              {callCenterNumbers.length > 0 ? (
                callCenterNumbers.map((number) => (
                  <div key={number.number_id} className="flex p-0! m-0! justify-between items-center!">
                    <div className="flex! p-0! m-0! gap-1 items-center!">
                      <img src={number.country_flag} className="w-4 h-4" alt="" />
                      <p className="flex justify-center! text-sm! text-[#264787]! m-0! p-0! items-center!">
                        {getCountryName(number)} :
                      </p>
                    </div>
                    <a href={`tel:${number.phone_number}`} className="hover:text-[#3b85c1] text-sm! transition-colors">
                      {number.phone_number}
                    </a>
                  </div>
                ))
                ...
                <>
                  <div className="flex p-0! m-0! justify-between items-center!">
                    <div className="flex! p-0! m-0!  gap-1 items-center!">
                      <img src="https://www.worldometers.info/images/flags/original/de.webp" className="w-4 h-4" alt=""/>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex!  gap-1 items-center!">
                      <img src="https://www.worldometers.info/images/flags/original/gb.webp" className="w-4 h-4" alt=""/>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex!  gap-1 items-center!">
                      <img src="https://www.worldometers.info/images/flags/original/nl.webp" className="w-4 h-4" alt=""/>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex!  gap-1 items-center!">
                      <img src="https://www.worldometers.info/images/flags/original/se.webp" className="w-4 h-4" alt=""/>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex!  gap-1 items-center!">
                      <img src="https://www.worldometers.info/images/flags/original/sy.webp" className="w-4 h-4" alt=""/>
          ...
          <div className="space-y-2 text-sm pt-4">
            <div className="flex gap-2">
              ...
              <a href={`tel:${phone || "+46850780055"}`} className="text-gray-600 hover:text-[#3b85c1] font-normal! transition-colors">
                {phone || "(+46) 850780055"}
              </a>
            </div>
            <div className="flex gap-2">
              <span className="font-bold text-[#264787] min-w-[100px]">Mobile Phone:</span>
              <a href={`tel:${mobile || "+46700097767"}`} className="text-gray-600 hover:text-[#3b85c1] font-normal! transition-colors">
                {mobile || "(+46) 0700097767"}
              </a>
            </div>
          </div>
          ...
          <div className="space-y-2 text-sm   pt-4">
            <div className="flex gap-2">
              ...
              <a href={`mailto:${email || "info@unotravelsweden.com"}`} className="text-gray-600 hover:text-[#3b85c1] font-normal! transition-colors">
                {email || "info@unotravelsweden.com"}
              </a>
            </div>
            <div className="flex gap-2">
              <span className="font-bold text-[#264787] min-w-[100px]">Licenses:</span>
              <span className="text-gray-600 font-normal! transition-colors">
                {orgNumber || "559288-2707"}
              </span>
            </div>
          </div>
